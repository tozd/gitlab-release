...
type Config struct {
	...
	BaseURL   string           `short:"B" name:"base" placeholder:"URL" default:"https://gitlab.com" type:"string" env:"CI_SERVER_URL" help:"Base URL for GitLab API to use. Default is \"${default}\". Environment variable: ${env}"`
